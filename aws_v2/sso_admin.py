"""
This module provides functionality for interacting with the AWS SSO Admin
service.
...
def create_account_assignment(
    ...
    target_id: str,
    principal_type: str,
    sso_admin_client: Optional[boto3.client] = None,
    ...
    Args:
        ...
        principal_id: The ID of the principal (user or group).
        target_id: The ID of the target AWS account.
        principal_type: The type of the principal (e.g., USER or GROUP).
        sso_admin_client: A boto3 SSO Admin client. Defaults to module
            client.

    Returns:
        An instance of AccountAssignmentCreationStatus containing the
        details of the account assignment.
    """
